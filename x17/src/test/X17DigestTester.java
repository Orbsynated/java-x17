import hash.X17Digest;
import org.junit.Test;
import org.spongycastle.util.encoders.Hex;

import static utils.HelperFunctions.*;

public class X17DigestTester {

  private static final X17Digest X_17_HASH;

  static {
    X_17_HASH = new X17Digest();
  }
  ...
  public void X17TesterMain() {
    ...
    testX17(
        X_17_HASH.digest(strToBytesArrayUTF8("The quick brown fox jumps over the lazy dog")),
